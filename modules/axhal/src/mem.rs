...
pub(crate) fn common_memory_region_at(idx: usize) -> Option<MemRegion> {
    ...
    let r = match idx {
        ...
        6  => MemRegion {
            paddr: 0x20008000.into(),
            size: 0x1000,
            flags: MemRegionFlags::DEVICE | MemRegionFlags::READ | MemRegionFlags::WRITE,
            name: "mmio",
        },
        7  => MemRegion {
            paddr: 0x32000000.into(),
            size: 0x8000,
            flags: MemRegionFlags::DEVICE | MemRegionFlags::READ | MemRegionFlags::WRITE,
            name: "mmio",
        },
        8  => MemRegion {
            paddr: 0x30000000.into(),
            size: 0x100000,
            flags: MemRegionFlags::DEVICE | MemRegionFlags::READ | MemRegionFlags::WRITE,
            name: "mmio",
        },
        9  => MemRegion {
            paddr: 0x33000000.into(),
            size: 0x4000,
            flags: MemRegionFlags::DEVICE | MemRegionFlags::READ | MemRegionFlags::WRITE,
            name: "mmio",
        },
        10  => MemRegion {
            paddr: 0x30e00000.into(),
            size:0x1000,
            flags: MemRegionFlags::DEVICE | MemRegionFlags::READ | MemRegionFlags::WRITE,
            name: "mmio",
        },
        11 => MemRegion {
            paddr: 0x83000000.into(),
            size: 0x1000000,
            flags: MemRegionFlags::READ | MemRegionFlags::WRITE | MemRegionFlags::RESERVED | MemRegionFlags::DEVICE,
            name: "mmio-buffer",
        },
        12 => MemRegion {
            paddr: 0x91000000.into(),
            size: 0x1000000,
            flags: MemRegionFlags::READ | MemRegionFlags::WRITE | MemRegionFlags::DEVICE | MemRegionFlags::RESERVED,
            name: "mmio-txbuffer",
        },
        _ => return None,
    };
