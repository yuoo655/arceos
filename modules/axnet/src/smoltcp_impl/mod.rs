...
const IP: IpAddress = IpAddress::v4(192, 168, 88, 77); // QEMU user networking default IP
const GATEWAY: IpAddress = IpAddress::v4(192, 168, 88, 7); // QEMU user networking gateway
const DNS_SEVER: IpAddress = IpAddress::v4(192,168,88,7);
