...
make LLVM=1 ARCH=arm64 O=build bsta1000b_defconfig
make LLVM=1 ARCH=arm64 O=build -j32
make LLVM=1 ARCH=arm64 O=build modules -j32
# make LLVM=1 ARCH=arm64 bsta1000b_defconfig
# make LLVM=1 ARCH=arm64 rust-analyzer 

cp build/arch/arm64/boot/Image.itb ~/deploy/